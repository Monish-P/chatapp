...
urlpatterns = [
    ...
    path('creategroup/',cviews.create_group,name='creategroup'),
    path('creategroup/group_name',cviews.group_name,name='group_name'),
    path('creategroup/add_users',cviews.add_users,name='add_users'),
    path('group/<str:group>/',cviews.group,name='group'),
    path('check_group',cviews.check_group,name='check_group'),
    path('exit_group/<str:gname>/',cviews.exit_group,name='exit_group'),
